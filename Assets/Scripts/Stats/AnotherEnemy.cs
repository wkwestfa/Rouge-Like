...
public class AnotherEnemy : LivingEntity, IStats
{
    ...
    public AnotherEnemy(string name, int healthPoints, int magicPoints, int physicalAttack, int magicAttack, int speed)
    {
        _name = name;
